...
create table Videojuego(idVideojuego integer auto_increment unique not null, titulo varchar(80) not null,
    ...
    not null, primary key(idVideojuego));
...
insert into Videojuegos values(1, 'Space Engineers', '0.4', 'Sandbox', 'Early access', 20),(2, 'MrHack', '1.0', 'Puzzle',
	'Completa', 5),(3, 'Minecraft', '1.12', 'Sandbox', 'Completo', 80),(4, 'Starcraft 2', '3.10' , 'Estrategia', 'Completo', 10),
    (5, 'Portal', '1.2', 'Puzzle', 'Completo', 15);
insert into Usuarios values(1,'Fernando' ,'Soto', "2005-01-15", '46587123L', 0.0), (2,'Juan' ,'Ortiz', "200-10-20", '45982017N', 0.25),
	(3,'Sara' ,'Ruiz', "1998-04-09", '63718529U', 15.1), (4,'Rosa' ,'Espino', "2004-05-05", '12345678W', 150.6), (5,'Pepe' ,'El Cateto',
    "2008-03-01", '57618342C', 3.75);
insert into Ventas values(1, 1, 2, "2007-06-07", 'Completo', false), (2, 4, 3, "2017-01-27", 'Completo', true),(3, 2, 1,
	"2006-09-17", 'Temporal', true),(4, 5, 3, "2014-12-01", 'Completo', false), (5, 3, 5, "2009-03-30", 'Completo', true);